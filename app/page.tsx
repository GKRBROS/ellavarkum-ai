...
export default function EllavarkkumPage() {
  ...
  return (
    <main className="min-h-screen bg-slate-50/50 text-slate-900 selection:bg-blue-100 font-inter">
          ...
          {step === "processing" && (
            ...
            >
               ...
               <div className="relative bg-white rounded-[40px] shadow-2xl border border-slate-100 p-10 sm:p-16 flex flex-col items-center gap-10 max-w-sm w-[90%]">
                <div className="absolute top-[-1px] left-[-1px] right-[-1px] h-1.5 bg-gradient-to-r from-blue-600 via-[#e1007a] to-blue-600 rounded-t-[40px] z-10" />
      ...
      {/* Social Community Modal (Post-Download) */}
      <AnimatePresence>
        {showSocialModal && (
          <div className="fixed inset-0 z-[300] flex items-center justify-center p-4 bg-slate-900/80 backdrop-blur-xl">
            <motion.div
              ...
              className="bg-white rounded-[48px] p-8 md:p-12 max-w-[440px] w-full shadow-[0_32px_64px_rgba(0,0,0,0.2)] relative border border-slate-100 text-center space-y-8"
            >
              <div className="absolute top-[-1px] left-[-1px] right-[-1px] h-2 bg-gradient-to-r from-blue-600 via-[#e1007a] to-blue-600 rounded-t-[48px]" />
              ...
              <div className="space-y-4">
                ...
                <h3 className="text-2xl md:text-3xl font-heading font-black text-slate-900 leading-tight">
                  {t.thankYouDownload}
                </h3>
                <p className="text-slate-500 font-medium text-lg">
                  {lang === "en" ? "Now, become a part of our growing community!" : "ഞങ്ങളുടെ കമ്മ്യൂണിറ്റിയുടെ ഭാഗമാകൂ!"}
                </p>
              </div>
              ...
              <div className="pt-4">
                <p className="text-slate-400 font-bold text-sm">Powered by Frame Forge</p>
              </div>
            </motion.div>
          </div>
        )}
